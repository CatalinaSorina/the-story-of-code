...
const rootReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actions.USE_MONEY:
      const refreshPlaces = getPlaces();
      // console.log("Refresh redux:", refreshPlaces);
      return {
        ...state,
        points: 0,
        money: 0,
    ...
    case actions.REMOVE_SELECTED_AREA:
      const placesWithoutSelectedPlace = state.places.filter(
        place => place.name !== "Selected area"
      );
      return {
        ...state,
